...
Host page loads this app in an iframe whose `src` is the deployed watchlySdk URL (HTTPS in production).
...
This folder is **standalone**: copy `watchly-sdk/` to a new repository root; it does not depend on other Sulaco packages.
